...
- [Safety and Data Handling](safety-and-data.md) — product safety, sensitive-data handling, network exposure, and local data erasure
- [Development](development.md) — setup, commands, and configuration guidance
