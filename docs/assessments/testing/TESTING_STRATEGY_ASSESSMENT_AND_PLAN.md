...
| `tests/unit/test_trio_therapist_agent.py` | Resumption/briefing prompt composition + context assembly | Medium | Several tests are “string contains”; one test has no meaningful assertion about style | Keep; tighten assertions + add negative/error path tests |
