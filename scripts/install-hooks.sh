...
echo "  • Commits and pushes run fast, branch-aware validation automatically"
echo "  • Set HOOK_FULL=1 for local release-candidate validation"
echo "  • Commit will be blocked if tests fail"
echo "  • Push will be blocked if finalization-check fails"
echo "  • Full validation remains required in CI and at phase/cutover checkpoints"
echo ""
echo "To uninstall:"
