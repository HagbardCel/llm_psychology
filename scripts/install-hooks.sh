...
echo "  • Pushes to the Phase 1 branch run the Phase 1 fast gate (validate-refactor-phase-1)"
echo "  • Pushes to main or HOOK_FULL=1 run full finalization-check"
echo "  • PRs targeting main also run full characterization in CI (phase-1-refactor-full)"
