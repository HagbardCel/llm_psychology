...
| Method | Keep intake method-neutral; choose a packaged method for initial review and therapy; Finish Intake requires a valid choice and makes it immutable; delete numerical ranking and unused plans; defer post-intake switching |
