...
|---|---|---|
| Intake conversation | Intake language, common conversation/orientation/safety policy, recent complete exchanges, current text | Selected-method metadata/instructions; a fabricated default method; plans for imagined methods; extracted slot JSON; other phase internals |
...
| Initial review | Entire intake transcript, profile method and intake language frozen at Finish Intake, orientation task | Other method plans/scores; unsupported demographic inference |
