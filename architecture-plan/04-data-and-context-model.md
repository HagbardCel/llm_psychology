...
|---|---|---|
| Intake conversation | Intake language, common conversation/orientation/safety policy, recent complete exchanges, current text | Selected-method metadata/instructions; a fabricated default method; plans for imagined styles; extracted slot JSON; other phase internals |
