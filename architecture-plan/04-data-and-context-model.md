...
|---|---|---|---|
| `profile` | Singleton method/default language; method fixed at Finish Intake; current-plan pointer set by application | Product defaults or explicit user input plus application pointer | Default language editable while idle; method editable only during intake |
