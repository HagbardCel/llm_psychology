...
from services.style_service import StyleService, StylePack
...
class TestStylePack:
    ...
    def test_style_pack_loading(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (style_dir / "psychoanalyst_prompt.txt").write_text("Test psychoanalyst prompt")
...
class TestStyleServiceIntegration:
    ...
    def test_load_style_packs_from_custom_directory(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (test_style_dir / "psychoanalyst_prompt.txt").write_text("Test therapy prompt")
            (test_style_dir / "reflection_prompt.txt").write_text("Test reflection prompt")
            (test_style_dir / "assessment_prompt.txt").write_text("Test assessment prompt")
