...
class TestLLMService:
    ...
    def test_generate_structured_response(self, mock_llm_service):
        ...
        response = mock_llm_service.generate_structured_response("Test prompt", "Expected format")
        assert response == mock_response
        mock_llm_service.generate_structured_response.assert_called_once_with("Test prompt", "Expected format")
