...
Connection details (base URL, model, api key, structured mode) and client
construction are shared with other real-model suites via
`tests.support.local_llm`; everything here is smoke-specific acceptance policy.
"""
