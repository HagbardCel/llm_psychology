...
def direct_agent_response(
    *,
    ...
    merged.setdefault("is_direct_response", True)
...
def continue_agent_response(
    *,
    content: str,
    metadata: dict[str, Any] | None = None,
) -> AgentResponse:
    """Create a standard continue response."""
    return build_agent_response(
        content=content,
...
def transition_agent_response(
    *,
    content: str,
    next_state: WorkflowState,
    metadata: dict[str, Any] | None = None,
) -> AgentResponse:
    """Create a response that triggers a workflow transition."""
    return build_agent_response(
        content=content,
