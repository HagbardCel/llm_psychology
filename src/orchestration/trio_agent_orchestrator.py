...
from models.data_models import Message, Session, TherapyPlan, UserProfile, UserStatus
...
class TrioAgentOrchestrator:
    ...
    async def process_message(
        ...
        try:
            ...
            await self._handle_agent_response(user_id, session_id, agent_response)
...
"""
    ...
    async def _handle_agent_response(
        ...
        if action == "transition":
            # Already handled transition above
            pass
